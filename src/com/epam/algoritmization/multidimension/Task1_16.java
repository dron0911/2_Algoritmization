...
public class Task1_16 {
    public static void main(String[] args) {
        ...
        int n = ConsoleReader.readIntValue("Enter an order of magic square");
        ResultPrinter.printMultiDimArray(squareMatrix(n));
    ...
    private static int[][] squareMatrix(int n) {
        ...
        while (n < 3) {
            ...
            n = ConsoleReader.readIntValue("Enter an order of magic square");
        }
        if ((n - 1) % 2 == 0) {
